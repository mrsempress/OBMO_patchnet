...
parser.add_argument('--obmo', action='store_true', help='whether use the OBMO modoule')
...
def main():
    ...
    train_loader, test_loader = build_dataloader(cfg['dataset'], dataset_helper, logger, obmo=args.obmo)

    # build model
    model = build_model(cfg['model'], dataset_helper, logger, obmo=args.obmo)
