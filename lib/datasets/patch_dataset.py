...
class PatchDataset(data.Dataset):
    def __init__(self, dataset_helper, pickle_file, patch_size,
                 ...
                 add_rgb=False, from_rgb_detection=False, logger=None, obmo=False):
    ...
    def __getitem__(self, index):
        ...
        if self.prob_list is None:
            ...
            return patch, center, angle_class, angle_residual, size_class, size_residual, rot_angle, one_hot_vec, self.prob_list[index]
