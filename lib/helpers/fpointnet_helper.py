...
def parse_outputs(output, num_heading_bin, num_size_cluster, mean_size_arr, output_dict, obmo=False):
    ...
    if obmo:
        output_dict['quality_scores'] = output[:, 3+2*num_heading_bin+4*num_size_cluster]
    return output_dict
